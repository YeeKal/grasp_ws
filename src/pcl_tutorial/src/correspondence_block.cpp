...
void showHelp (char *filename)
{
    ...
    std::cout << "Reference: rosrun pcl_tutorial correspondence_grouping src/pcl_tutorial/materials/milk.pcd  src/pcl_tutorial/materials/milk_cartoon_all_small_clorox.pcd -c"<<std::endl;
...
int main (int argc, char *argv[])
{
    ...
    pcl::PointCloud<PointType>::Ptr model_before_filter (new pcl::PointCloud<PointType> ());
    pcl::PointCloud<PointType>::Ptr model (new pcl::PointCloud<PointType> ());
    pcl::PointCloud<PointType>::Ptr model_keypoints (new pcl::PointCloud<PointType> ());
    pcl::PointCloud<PointType>::Ptr scene_pass (new pcl::PointCloud<PointType> ());
    pcl::PointCloud<PointType>::Ptr model_pass (new pcl::PointCloud<PointType> ());


    pcl::PointCloud<PointType>::Ptr scene_ground (new pcl::PointCloud<PointType> ()),scene_filter (new pcl::PointCloud<PointType> ());
    ...
    //  Load clouds
    //
    if (pcl::io::loadPCDFile (model_filename_, *model_before_filter) < 0)
    {
        std::cout << "Error loading model cloud." << std::endl;
        showHelp (argv[0]);
        return (-1);
    }
    if (pcl::io::loadPCDFile (scene_filename_, *scene_pass) < 0)
    {
    ...
    // pass.setFilterLimits (0.30, 0.4);
    // pass.filter (*model_before_filter);

    //model filtering
    std::cout<<"model size before filter:"<<model_before_filter->points.size()<<endl;
    pcl::VoxelGrid<PointType> sor;
    sor.setInputCloud (model_before_filter);
